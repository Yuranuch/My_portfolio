        ...
        <div className={styles.contacts}>
            <div className={styles.container}>
                ...
                <div className={styles.contactsInfo}>
                    ...
                    <div className={styles.infoItem}><span>GitHub: </span><a href="https://github.com/Yuranuch">https://github.com/Yuranuch</a></div>
                    <div className={styles.infoItem}><span>Free-lancer: </span><a href="https://www.fl.ru/users/yuranuch/">www.free-lance.ru/users/Yuranuch</a></div>
