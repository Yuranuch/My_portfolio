        ...
        <div className={styles.aboutMe}>
            <div className={styles.container}>
                ...
                <Fade clear>
                    ...
                    <p>I prefera healthy lifestyle like traveling, biking, football</p>
                    <p>In 2008 I graduated from the Brest Polytechnic University with a degree in Economics and
                        Enterprise Management.</p>
                    <p>For almost 14 years I have worked in the food trade. I was a sales agent, then I was the manager
                    ...
                    <p>I have experience teaching people, I have experience in recruiting</p>
                    <p>I plan to develop myself and become the best web developer.</p>
                    <p>And now I think I will be useful for you)</p>
                </Fade>
            </div>
        </div>
    )
